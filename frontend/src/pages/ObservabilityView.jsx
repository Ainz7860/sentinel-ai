...
export default function ObservabilityView({ apiBase }) {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass-card p-6 rounded-2xl flex items-center justify-between">
          <div>
            <p className="text-xs text-slate-400 font-semibold uppercase tracking-wider">Average Pipeline Latency</p>
            <h3 className="text-3xl font-bold mt-2 font-mono text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="glass-panel p-6 rounded-2xl space-y-4">
          <div>
            ...
            <p className="text-xs text-slate-400 font-sans">Average time spent in milliseconds by each agent module.</p>
          </div>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={barData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Tooltip
                  ...
                  itemStyle={{ color: '#fff' }}
                />
                <Bar dataKey="latency" fill="#6366f1" radius={[6, 6, 0, 0]} name="Latency (ms)" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="glass-panel p-6 rounded-2xl space-y-4">
          <div>
            ...
            <p className="text-xs text-slate-400">Total transaction distribution across agent instances.</p>
          </div>
          <div className="h-64 flex justify-center items-center">
            <ResponsiveContainer width="100%" height="100%">
              <RadarChart cx="50%" cy="50%" outerRadius="75%" data={radarData}>
                ...
                <Radar name="Invocations" dataKey="invocations" stroke="#06b6d4" fill="#06b6d4" fillOpacity={0.2} />
                <Tooltip
                  contentStyle={{ backgroundColor: '#0f172a', borderColor: '#334155', borderRadius: '12px' }}
                />
              </RadarChart>
